...
CON (Constituição) é uma medida de saúde e robustez. CON é usado para determinar os [Pontos de Vida](0001_Characters.md?id=hit-points) e a [Taxa de Cura](0001_Characters.md?id=Cura-rate) (veja abaixo). Se a CON chegar a zero por qualquer motivo, o personagem morre.
...
Observe que as porcentagens básicas para algumas habilidades serão modificadas tanto pela cultura quanto pela profissão, portanto, esses vaSabers iniciais mudarão à medida que a criação do personagem avança.
...
Em _Classic Fantasy Imperative_, os jogadores geralmente podem escolher entre uma das seis raças para seus personagens: Humanos ou uma das raças semi-humanas (Anão, Elfo, Gnomo, Meio-Elfo, Meio-Orc ou Halfling). Se o personagem for humano, ele deve definir seu personagem dentro de um dos três antecedentes culturais: Bárbaro, Civilizado e Nômade. Para os humanos, a cultura determina o tipo de sociedade em que o personagem foi criado e, portanto, prescreve certas perspectivas e filosofias que eles podem ter. Mais pragmaticamente, a cultura ajuda a definir os vaSabers das várias perícias que moldam as capacidades gerais do seu personagem. As raças semi-humanas, em geral, vêm de uma cultura racial que é muito mais estereotipada do que a raça em geral. Consulte os textos sobre raça e cultura no [Capítulo 2](0002_Culture_and_Races.md) para obter mais informações.

Todos os personagens têm um Alinhamento, que consiste em um Código Ético e um Código Moral, bem como duas ou três Paixões. Alguns terão um Juramento a uma ordem religiosa, guilda ou organização. Cada descrição de Classe apresenta quaisquer Alinhamentos ou Juramentos necessários. Antes de continuar, procure sua raça no  [Capítulo 2](0002_Culture_and_Races.md) e anote o Alinhamento e as Paixões sugeridos, e verifique a seção de [Classes](0003_Classes.md) para ver se existem quaisquer requisitos de Alinhamento ou Juramento. Consulte o [Capítulo 4, Alinhamento & Paixões](0004_Alignment_and_Passions.md), para determinar quaisquer detalhes específicos sobre seu Alinhamento, Paixões e Juramentos, se houver.

Cada raça e cultura lista uma variedade de Perícias Básicas que o personagem aprende como parte de seu desenvolvimento formativo dentro dessa sociedade. Essas são habilidades essenciais que todos os personagens da mesma cultura específica melhoram em algum grau. Os personagens também aprendem algumas Perícias Profissionais especializadas ou esotéricas de acordo com seus interesses pessoais.

As Perícias Profissionais são explicadas com mais detalhes no capítulo sobre [Perícias](0005_Skills.md), mas, em resumo, representam aquelas perícias que não podem ser tentadas sem anos de estudo rigoroso e treinamento especializado. Enquanto um personagem tem uma habilidade básica em todas as Perícias Básicas, ele não tem habilidade alguma em nenhuma Perícia Profissional, a menos que seja escolhida como parte de sua criação cultural ou Classe.

As Perícias Profissionais escolhidas começam com o valor de Nível Base da Característica, conforme as Perícias Básicas. Algumas Habilidades Profissionais, como Artesanato, Idiomas ou Conhecimentos, oferecem a escolha de uma especialização. Nesses casos, a especialidade escolhida deve ser aquela que se adequa à cultura.

### Seleções Rápidas de Perícias Raciais

As Seleções Rápidas fornecem uma seleção média de habilidades, permitindo uma criação rápida de personagens. Sinta-se à vontade para trocar os pontos, se desejar; no entanto, nenhuma perícia pode ter menos do que um bônus de +5 ou mais do que um bônus de +15.

##### Tabela de seleção rápida de perícias raciais

Aqui estão as **Seleções Rápidas de Habilidades Raciais** para diferentes raças e culturas:

| Raça/Cultura | Perícias Básicas | Perícias Profissionais |
| :-- | :-- | :-- |
| Humano (Bárbaro, Tipo Guerreiro) | Atletismo +10, Musculatura +10, Tolerância +15, Primeiros Socorros+5, Local+10, Percepção +10, e Canoagem ou Montaria +10 | Navegação +10, Marinhagem ou Sobrevivência +10, Rastrear +10 |
| Humano (Bárbaro, Pessoa Sábia) | Atletismo +5, Tolerância +5, Primeiros Socorros +15, Local +15, Percepção +15, e Canoagem ou Montaria +10 | Cura +10, Idioma (qualquer\*) +10, Saber (qualquer) +15 |
| Humano (Civilizado, Esperto de Rua) | Ocultação +10, Dissimulação +15, Condução +5, Influência +10, Intuição +10, Local +10, Força de Vontade +10 | Ofício (qualquer) +5, Comércio +10, Manha +15 |
| Humano (Civilizado, Culto) | Ocultação +5, Dissimulação +5, Condução +5, Influência +10, Intuição +15, Local +15, Força de Vontade +10 | Comércio +10, Idioma (qualquer\*) or Saber (qualquer) +10, Saber (qualquer) ou Música +15 |
| Humano (Nômade, Tipo Guerreiro) | Tolerância +10, Primeiros Socorros +5, Local +5, Percepção +10, Furtividade +10, e duas das seguintes em +15 cada: Atletismo, Canoagem, Condução, Montaria, ou Natação (dependendo do modo de viagem principal) | Navegação +10, Sobrevivência +10, Rastrear +10 |
| Humano (Nômade, Pessoa Sábia) | Tolerância +5, Primeiros Socorros +15, Local +10, Saber (qualquer), +15, Percepção +10, Furtividade +5, e duas das seguintes em +5 cada: Atletismo, Canoagem, Condução, Montaria, ou Natação (dependendo do modo de viagem principal) | Cura +10, Idioma (qualquer\*) +10, Saber (qualquer) +10 |
| Humano (Primitivo, Tipo Guerreiro) | Musculatura +10, Tolerância +10, Evasão +10, Local +5, Percepção +10, Furtividade +15, e uma das seguintes Atletismo, Canoagem, Primeiros Socorros, ou Natação +10 | Sobrevivência +10, Rastrear +10; e uma das seguintes Atletismo, Canoagem, Primeiros Socorros, Navegação, ou Natação +10 |
| Humano (Primitivo, Pessoa Sábia) | Tolerância +5, Evasão +5, Primeiros Socorros +15, Local +15, Percepção +15, Furtividade +5, e um dos seguintes Atletismo, Canoagem, ou Natação +5 | Cura +10, Idioma (qualquer\*) +10, Saber (qualquer), +15 |
| Anão | Atletismo +10, Musculatura +15, Tolerância +10, Evasão +10, Local +10, Percepção +5, Força de Vontade +10 | Comércio ou Mecanismos +10, Ofício. (qualquer) +10, Sobrevivência +10 |
| Elfo | Ocultação +5, Influência +10, Intuição +10, Local +10, Percepção +15, Furtividade +10, Força de Vontade +10 | Sobrevivência +10, e duas das seguintes, a +10 cada: Idioma (qualquer\*\*), Saber (qualquer), ou Música |
| Gnomo | Dissimulação +10, Evasão +15, Intuição +10, Local +10, Percepção +5, Furtividade +10, Força de Vontade +10 | Comércio +10, Ofício. (qualquer) +10, Mecanismos ou Sobrevivência +10 |
| Meio-Elfo (Criado como Elfo) | Ocultação +10, Influência +10, Intuição +10, Local +10, Percepção +10, Furtividade +10, Força de Vontade +10 | Idioma (qualquer\*\*) +10, Saber (qualquer) +10, Música or Sobrevivência +10 |
...
| Classe | Perícias Básicas | Perícias Profissionais |
| :-- | :-- | :-- |
...
Um personagem pode optar por começar no Nível 0 se não tiver níveis de habilidade suficientes e atingir o Nível 1 durante o jogo, se desejar, mas para poder usar ou lançar magias, esses pré-requisitos devem ser atendidos.
